...
export async function GET(req: Request) {
  try {
    ...
    let query = supabaseAdmin
      ...
      .select(
        `
        id, titulo, precovenda, precocompra, estoque, estoqueminimo, unidade, referencia, status_estoque, fabricante, exibirPdv, conservacao
        `,
        { count: 'exact' }
      )
