...
export async function GET(req: Request) {
  try {
    ...
    let query = supabaseAdmin
      ...
      .select(
        `
        id, titulo, descricao, precovenda, estoque, estoqueminimo, unidade, referencia, status_estoque, fabricante, grupo: produtogrupo(id, nome, descricao, ativo), exibirPdv, tituloMarketplace, descricaoMarketplace, imgUrl
        `
      )
