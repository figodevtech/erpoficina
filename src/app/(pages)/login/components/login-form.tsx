  ...
  return (
    <div className={cn("flex flex-col gap-6", className)} {...props}>
      <Card className="overflow-hidden p-0">
        <CardContent className="grid p-0 md:grid-cols-2">
          ...
          <div className="bg-muted relative hidden overflow-hidden md:block group">
            ...
            <div
            className="absolute inset-0 bg-gradient-to-b from-blue-800/50 to-cyan-300/10 z-10"
            ></div>
      ...
      <div className="text-muted-foreground *:[a]:hover:text-primary text-center text-xs text-balance *:[a]:underline *:[a]:underline-offset-4">
        Clicando em continuar você estará sujeito aos <a href="#">Termos de Serviço</a>{" "}
        e a <a href="#">Política de Privacidade</a>.
      </div>
    </div>
  )
}
