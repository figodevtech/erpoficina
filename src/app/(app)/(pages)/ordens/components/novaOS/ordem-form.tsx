...
export function FormularioNovaOS({
  ...
  const buscarClientePorDocumento = async () => {
    ...
    try {
      ...
      const j = await r.json();
      if (!r.ok)
        throw new Error(j?.error || "Não foi possível buscar o cliente.");
    ...
    <div className="space-y-6">
      ...
      <Card className="border-border">
        <CardHeader className="pb-3">
          ...
          <CardDescription>
            Busque pelo CPF/CNPJ ou informe os dados para atendimento avulso.
          </CardDescription>
        </CardHeader>
            ...
            <>
              <div className="space-y-2">
                ...
                <Select
                  ...
                  disabled={
                    (modoAtendimento === "cadastrado" && !cliente) ||
              ...
              <div className="grid grid-cols-1 sm:grid-cols-3 gap-3">
                <div className="space-y-1.5">
                  ...
                  <Input
                    value={vPlaca}
                    onChange={(e) =>
                      setVPlaca(e.target.value.toUpperCase())
                    }
                    placeholder="ABC1D23"
