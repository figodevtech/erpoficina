...
import { ChevronLeftIcon, ChevronRightIcon, ChevronsLeft, ChevronsRight, Loader, Search } from "lucide-react";
...
export default function CustomerSelect({ children, OnSelect }: CustomerSelectProps) {
