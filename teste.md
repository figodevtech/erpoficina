estou construindo um dialog para registrar entradas de estoque.
          ...
          <div className="h-full min-h-0 overflow-auto dark:bg-muted-foreground/5 px-6 py-10 space-y-2">
            ...
            <div className="lg:col-span-2 border-b lg:border-b-0 lg:border-r p-6 space-y-4">
              <div className="space-y-2">
                ...
                >
                  <SelectTrigger size="sm" className="w-50 text-xs">
                    <SelectValue placeholder="Selecione o tipo" />
                  </SelectTrigger>
                  <SelectContent className="text-xs">
                    {tipoOptions.map((opt) => (
                      <SelectItem className="text-xs hover:cursor-pointer" key={opt.value} value={opt.value}>
                        {opt.label}
                      </SelectItem>
                    ))}
                  </SelectContent>
...
ao selecionar o produto, em productSelect, ele retorna um objeto do tipo produto aasim:
...
baseado, nesta tabela, devemos contrstruir um item para a entrada neste modelo da tabela:
...
neste dialog podemos inserir vários produtos que vão se tornar itens da entrada. Para construir a entrada neste modelo:
