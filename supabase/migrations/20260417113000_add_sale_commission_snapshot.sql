...
add column if not exists comissao_venda_percent numeric(5,2);

alter table public.venda
add column if not exists comissao_venda_percent_aplicada numeric(5,2);
...
declare
  ...
  v_comissao_venda_percent_aplicada numeric;
  v_venda_id integer;
  v_itens jsonb;
  v_item jsonb;
...
begin
  ...
  select coalesce(u.comissao_venda_percent, 0)
    into v_comissao_venda_percent_aplicada
  ...
  insert into public.venda (
    ...
    v_comissao_venda_percent_aplicada
  )
