...
CREATE UNIQUE INDEX osservico_realizador_pkey ON public.osservico_realizador USING btree (ordemservicoid, servicoid, usuarioid);
...
alter table "public"."osservico_realizador" add constraint "osservico_realizador_pkey" PRIMARY KEY using index "osservico_realizador_pkey";
...
alter table "public"."empresa" add constraint "empresa_ambiente_check" CHECK (((ambiente)::text = ANY ((ARRAY['HOMOLOGACAO'::character varying, 'PRODUCAO'::character varying])::text[]))) not valid;
...
alter table "public"."empresa" add constraint "empresa_regimetributario_check" CHECK (((regimetributario)::text = ANY ((ARRAY['1'::character varying, '2'::character varying, '3'::character varying])::text[]))) not valid;
...
alter table "public"."ordemservico" add constraint "ordemservico_alvo_consistente" CHECK ((((alvo_tipo = 'VEICULO'::public.enum_alvo_reparo) AND (veiculoid IS NOT NULL) AND (pecaid IS NULL)) OR ((alvo_tipo = 'PECA'::public.enum_alvo_reparo) AND (pecaid IS NOT NULL) AND (veiculoid IS NULL)))) NOT VALID not valid;
...
alter table "public"."osproduto" add constraint "fk_os_produto_ordem" FOREIGN KEY (ordemservicoid) REFERENCES public.ordemservico(id) not valid;

alter table "public"."osproduto" validate constraint "fk_os_produto_ordem";
...
alter table "public"."osservico_realizador" add constraint "fk_or_osservico" FOREIGN KEY (ordemservicoid, servicoid) REFERENCES public.osservico(ordemservicoid, servicoid) ON DELETE CASCADE not valid;

alter table "public"."osservico_realizador" validate constraint "fk_or_osservico";

alter table "public"."osservico_realizador" add constraint "fk_or_usuario" FOREIGN KEY (usuarioid) REFERENCES public.usuario(id) ON UPDATE CASCADE not valid;

alter table "public"."osservico_realizador" validate constraint "fk_or_usuario";
...
alter table "public"."venda" add constraint "vendaonline_usuariocriadorid_fkey" FOREIGN KEY (usuariocriadorid) REFERENCES public.usuario(id) not valid;

alter table "public"."venda" validate constraint "vendaonline_usuariocriadorid_fkey";
...
begin
  ...
  v_usuario_criador_id := (p_venda->>'usuarioCriadorId')::uuid;
  ...
  if v_cliente_id is null
     or v_usuario_criador_id is null
     or v_status is null
     or v_sub_total is null
     or v_valor_total is null then
    raise exception 'Campos obrigatórios ausentes em p_venda (clienteId, usuarioCriadorId, status, subTotal, valorTotal).'
      using errcode = 'P0001';
  end if;
...
CREATE OR REPLACE FUNCTION public.recalcular_comissao_osservico(p_ordemservicoid integer, p_servicoid integer)
 RETURNS void
 LANGUAGE plpgsql
AS $function$
declare
...
CREATE OR REPLACE FUNCTION public.tg_recalc_comissao_osservico_on_subtotal()
 RETURNS trigger
 LANGUAGE plpgsql
AS $function$
begin
...
CREATE OR REPLACE FUNCTION public.tg_recalc_comissao_osservico_realizador()
 RETURNS trigger
 LANGUAGE plpgsql
AS $function$
begin
...
CREATE OR REPLACE FUNCTION public.tg_set_comissao_percent_aplicada()
 RETURNS trigger
 LANGUAGE plpgsql
AS $function$
begin
...
grant delete on table "public"."osservico_realizador" to "anon";

grant insert on table "public"."osservico_realizador" to "anon";

grant references on table "public"."osservico_realizador" to "anon";

grant select on table "public"."osservico_realizador" to "anon";

grant trigger on table "public"."osservico_realizador" to "anon";

grant truncate on table "public"."osservico_realizador" to "anon";

grant update on table "public"."osservico_realizador" to "anon";

grant delete on table "public"."osservico_realizador" to "authenticated";

grant insert on table "public"."osservico_realizador" to "authenticated";

grant references on table "public"."osservico_realizador" to "authenticated";

grant select on table "public"."osservico_realizador" to "authenticated";

grant trigger on table "public"."osservico_realizador" to "authenticated";

grant truncate on table "public"."osservico_realizador" to "authenticated";

grant update on table "public"."osservico_realizador" to "authenticated";

grant delete on table "public"."osservico_realizador" to "service_role";

grant insert on table "public"."osservico_realizador" to "service_role";

grant references on table "public"."osservico_realizador" to "service_role";

grant select on table "public"."osservico_realizador" to "service_role";

grant trigger on table "public"."osservico_realizador" to "service_role";

grant truncate on table "public"."osservico_realizador" to "service_role";

grant update on table "public"."osservico_realizador" to "service_role";
...
CREATE TRIGGER trg_recalc_osservico_subtotal AFTER UPDATE OF subtotal ON public.osservico FOR EACH ROW EXECUTE FUNCTION public.tg_recalc_comissao_osservico_on_subtotal();

CREATE TRIGGER trg_recalc_or_del AFTER DELETE ON public.osservico_realizador FOR EACH ROW EXECUTE FUNCTION public.tg_recalc_comissao_osservico_realizador();

CREATE TRIGGER trg_recalc_or_ins AFTER INSERT ON public.osservico_realizador FOR EACH ROW EXECUTE FUNCTION public.tg_recalc_comissao_osservico_realizador();

CREATE TRIGGER trg_set_or_percent_before_ins BEFORE INSERT ON public.osservico_realizador FOR EACH ROW EXECUTE FUNCTION public.tg_set_comissao_percent_aplicada();
