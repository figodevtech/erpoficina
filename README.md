...
- [ ] Foto e histórico de manutenção por veículo
...
- [ ] Sistema de multi-unidade (franquias)

---

## 🤝 Contribuindo

Estamos abertos a contribuições! Se você deseja ajudar a melhorar o ERP Oficina:
...
- Verifique a documentação técnica em [docs/TECHNICAL.md](docs/TECHNICAL.md)
...
- Informações do seu ambiente (SO, navegador, versão do Node.js)

### Sugerir Features

Tem uma ideia legal? Abra uma discussão (issue com label `enhancement`) com:
